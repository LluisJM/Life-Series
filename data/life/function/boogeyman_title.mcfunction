tag @r[team=!red_names,team=!spectators,tag=!boogeyman] add boogeyman
...
tellraw @a[tag=boogeyman] [{"text":"","color":"gray"},"You are the boogeyman. You must by any means necessary kill a ",{"text":"green","color":"green"}," or ",{"text":"yellow","color":"yellow"}," name by direct action to be cured of the curse. If you fail, next session you will become a ",{"text":"red","color":"red"}," name. All loyalties and friendships are removed while you are the boogeyman."]
tellraw @a[tag=boogeyman] [{"text":"","color":"gray"},"If you don't get automatically cured when you perform a kill, please notify an administrator."]
...
tellraw @a[tag=!boogeyman] [{"text":"","color":"gray"},"You are NOT the boogeyman. The Boogeyman needs, by any means, kill a ",{"text":"green","color":"green"}," or ",{"text":"yellow","color":"yellow"}," name by direct action to be cured of the curse. All loyalties and friendships are removed while he/she is the boogeyman. Beware of him/her!"]